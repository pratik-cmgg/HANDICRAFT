<%@ Page Title="" Language="C#" MasterPageFile="~/adminSite/AdminMasterPage.master" AutoEventWireup="true" CodeFile="viewOrders.aspx.cs" Inherits="adminSite_viewOrders" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
     <form id="form1" runat="server">
        ...
        <div class="container" style="width:1100px;margin-left:200px;margin-top:100px">
           ...
           <asp:Label ID="lblmsg" runat="server" Text="Oreder Details" ForeColor="#0033CC" Enabled="False" Font-Bold="True" Font-Names="Georgia" Font-Size="Medium"></asp:Label> 
        </div>
