<%@ Page Title="" Language="C#" MasterPageFile="~/adminSite/AdminMasterPage.master" AutoEventWireup="true" CodeFile="viewCategory.aspx.cs" Inherits="adminSite_viewCategory" %>
      ...
      <form id="form1" runat="server">
        ...
        <div class="container" style="border:double;height:580px;width:1100px;margin-left:200px;margin-top:100px">
            <div class="col-lg-6" style=" float: left; height: 400px">
                <div style="">
                                     <asp:GridView ID="GridView1" runat="server" Font-Bold="false" BackColor="White" BorderColor="#3366CC" BorderWidth="1px" CellPadding="4" BorderStyle="None" DataKeyNames="cat_id" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" CellSpacing="2" Width="298px" AllowCustomPaging="True">
