<%@ Page Title="" Language="C#" MasterPageFile="~/adminSite/AdminMasterPage.master" AutoEventWireup="true" CodeFile="viewJoinRequest.aspx.cs" Inherits="adminSite_viewJoinRequest" %>
    ...
    <form id="form1" runat="server">
        ...
        <div style="margin-top:100px">
            ...
            <div class="col-lg-3" style="float:left;height:400px;margin-left:20px">
                <asp:GridView ID="GridView1" runat="server" Font-Bold="false" BackColor="White" BorderColor="#3366CC" BorderWidth="1px" CellPadding="4" BorderStyle="None" DataKeyNames="id" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" CellSpacing="2" Width="298px" AllowCustomPaging="True">
            ...
            <div class="col-lg-4" style="float:left;">
                <div style="position: absolute; width: 400px; height:408px;margin-left:15px;" > 
                      <asp:Label ID="lblmsg" runat="server" Text="Join Request Details" ForeColor="#0033CC" Enabled="False" Font-Bold="True" Font-Names="Georgia" Font-Size="Medium"></asp:Label> 
                    <asp:Image ID="productimage" runat="server" Height="300px" Width="300px" />
