<%@ Page Title="" Language="C#" MasterPageFile="~/adminSite/AdminMasterPage.master" AutoEventWireup="true" CodeFile="ViewRegisteredUsers.aspx.cs" Inherits="adminSite_ViewRegisteredUsers" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
     <form id="form1" runat="server">
        ...
        <div class="container" style="border:double;height:520px;width:1100px;margin-left:200px;margin-top:100px">
            <div class="col-lg-6" style="float:left;height:400px">
                 <asp:GridView ID="GridView1" runat="server" Font-Bold="false" BackColor="White" BorderColor="#3366CC" BorderWidth="1px" CellPadding="4" BorderStyle="None" DataKeyNames="cust_id" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" CellSpacing="2" Width="298px" AllowCustomPaging="True">
            ...
            <div class="col-lg-6" style="float:right;height:500px">
                <div style="position: absolute; width: 400px; height:408px;margin-left:30px;border:ridge" > 
